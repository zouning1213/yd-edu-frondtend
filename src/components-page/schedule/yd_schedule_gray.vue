<template>
    ...
    <div>
        ...
        <div>
            <div ref="print" class="yd-schedule-grade" v-if="Object.keys(tableData).length > 0 && loading == true">
                <table class="schedule-table">
                    <thead class="table-head">
                    <tr>
                        <th width="8%"></th>
                        <th class="arrow" width="8%"><img src="./img/arrow-gray.png"/></th>
...
<script>
    import './css/yd_schedule_gray.less'
