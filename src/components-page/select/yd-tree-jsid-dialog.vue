<template>
    ...
    <div class="yd-common-select-tree">
        <div class="bg-skin tree-title border-skin"><h3>选择教师</h3></div>
            ...
            <el-tree
                ...
                <div class="custom-tree-node" slot-scope="{node,data }">
                    <span>
                        ...
                        <i v-if="data.id.substring(0,1) == 'j'" class="yd icon-tree-teacher"></i>
                        {{data.label}}
                        <label class="point" v-show="data.noun==1">班主任</label>
                    </span>
                </div>
            </el-tree>
        </div>
        ...
        methods:{
            ...
            changeTree(data,node) {
                if (data.id.substring(0,1) == 'j') {
                    ...
                    //父组件点击确定的时候调用了此方法 this.submitTree()
                }
            },
            submitTree() { //提交教研组
