            ...
            <el-tree
                ...
                <div class="custom-tree-node" slot-scope="{node,data }">
                    <span>
                        ...
                        <i v-if="data.id.substring(0,2) == 'ks'" class="yd icon-tree-major"></i>
                        <i v-if="data.id.substring(0,2) == 'kc'" class="yd icon-teaching"></i>
                        {{data.label}}
                    </span>
                </div>
            </el-tree>
            ...
            submitTree() { //提交教研组
                ...
                if (treeCheckedId.length > 0) {
                    ...
                    treeCheckedId.forEach((item) => {
                        checkedId.push(item.substring(2))
                    })
