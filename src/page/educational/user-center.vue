         ...
         <div class="yd-bg common-pd">
            ...
            <el-form :model="ruleForm" status-icon :rules="rules" ref="ruleForm"  width='320px' class="demo-ruleForm">
                <el-form-item label="" prop="age" style="width:320px">
                    <el-input type="password" v-model.number="ruleForm.age" placeholder="请输入原始密码" ><i slot="prefix" class="el-input__icon el-icon-lock"></i></el-input>
                </el-form-item>
                <el-form-item label="" prop="pass" style="width:320px">
                    <el-input type="password" v-model="ruleForm.pass" autocomplete="off" placeholder="请输入新密码" ><i slot="prefix" class="el-input__icon el-icon-lock"></i></el-input>
                </el-form-item>
                <el-form-item label="" prop="checkPass" style="width:320px">
                    <el-input type="password" v-model="ruleForm.checkPass" autocomplete="off" placeholder="再次确定密码" ><i slot="prefix" class="el-input__icon el-icon-lock"></i></el-input>
                </el-form-item>
                <el-form-item>
