<template>
    ...
    <div>
        <gradeChild :radio='radio' ref="isgradechild" :form="form">
            <!-- 父亲组件 -->
            <el-row slot="searchwrap"
                    class="yd-router-title yd-bg  mt-0 yd-educational-grade-biao">
