<template>
    <div>
        <!--选项卡-->
        <div class="arranging-common-tab">
            <el-button size="medium" type="primary">按教师调课</el-button>
            <el-button size="medium">按班级调课</el-button>
        </div>
        <!--下拉选项-->
        <el-row class="arranging-common-select">
            <el-col :span="12">
                <el-select v-model="checked_kcid" @change="changeKcid" filterable placeholder="选择课程" size="mini">
                    <el-option
                ...
                <el-select v-model="checked_jsid" @change="changeJsid" filterable placeholder="选择教师" size="mini">
                    <el-option
...
<script>
    ...
    import adjustTeacher from './arranging/adjust-teacher'
    import adjustClass from './arranging/adjust-class'
