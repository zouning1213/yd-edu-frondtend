...
<template>
    <div class="yd-mobile-cropperPic">
        <!-- 遮罩层 -->
        <!--cutStyle == 1  用户者上传头像-->
            ...
            <div :class="['crop-container',cutStyle == 1 ? 'crop-container-round' : '']" v-show="panel">
                <div class="container-content">
                    ...
                    <div class="crop-btn-group clearfix">
                        <van-button class="crop-btn" size="small" type="default" @click="cancel">取消</van-button>
                        <van-button class="crop-btn" size="small" type="primary" @click="commit">确定</van-button>
                    </div>
                </div>
            </div>
